...
{
    class SetAnimalShopName : Command
    {
        public SetAnimalShopName(IModHelper helper, IMonitor monitor, ModConfig config)
        ...
        public override void Callback(string command, string[] args)
        {
            try
            {
                ...
                Helpers.Assert.RequiredArgumentOrder(args.Length, 2, "name");
